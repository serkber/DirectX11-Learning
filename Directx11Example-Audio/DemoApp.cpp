...
{
    HRESULT hr = DirectX::CreateDDSTextureFromFile(m_pD3DDevice, m_pD3DContext, Textures[Tex::Suzanne], &m_pColorMapResource, &m_pColorMapOne);
    if (FAILED(hr))
    {
...
bool DemoApp::LoadContent()
{
    ...
    modelImporter.LoadModel("Suzanne2.fbx");
